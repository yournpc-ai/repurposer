...
| 2 | 金句卡 `quote-cards` | 金句叠卡 | 挑出最亮的几句话，叠成一张可以直接发的金句卡 | 录像 / 照片+文稿 / 纯文稿（合成类，宽槽三路径——v3 工程见简报） | ✅ Live（叠卡本体化施工中） |
