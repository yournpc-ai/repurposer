...
**结果画布构图**：左 = 素材节点（asset 皮）；中 = 工件卡（渲染单元：计划 / 选段 / 配音 / 音乐，D6 修订）+ 过程脊（无键管道步骤的折叠组节点，点击就地展开）；右 = 产物节点列（output 皮大卡）。边 = 真边（dependency / lineage 双语义，视觉可辨）。
