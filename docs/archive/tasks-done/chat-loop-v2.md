...
> 依据：`docs/CHAT_ARCHITECTURE.md` §3（dispatch 三类目标）/§7（mentions）；`docs/archive/tasks-done/chat-loop-v1.md`（v1 地基已在 main）；`docs/archive/tasks-done/operation-model.md`（edit ops 地基，并行简报）
