...
1. **Opus 向 B 端基础设施移动**（OpusSearch + API + 配音）。如果它 2027 年做"面向机构的版本"，我们必须在它之前把 EU 驻留和 persona 复利做成既成事实——**窗口约 12–18 个月**。这是 EU 驻留（ROADMAP §7 P2）和 persona 项不能再往后压的理由。
