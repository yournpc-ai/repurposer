...
const zh: Resources = {
  ...
  recipes: {
    ...
    "voice-dub": {
      ...
      inputHint: "在这里上传你的原视频。",
      promptTemplate:
        "把我的视频配成中文、法语和西班牙语——用我自己的声音，不要合成播音腔。",
      promptHint:
    ...
    "social-post": {
      ...
      promptTemplate:
        "帮我写一条社媒帖。",
      // 2026-08-24 双模板：overlay 已挂附件时预填更具体版本——无素材时仍走小白原声（小声）。
    ...
    "quote-cards": {
      ...
      // promptHint 教用户两条可改维度（RECIPES §7.2）：语言对 + 字幕
      // 模式——都走 chat（按 promptHint = 引导句而非选择器控件的纪律）。
      promptHint:
        "默认中英双语。在对话里改你自己的语言对和字幕模式（双语 / 只保留源语言 / 只保留目标语言）。",
    },
    carousel: {
      title: "轮播图",
      promise:
    ...
    "image-video": {
      ...
      promptTemplate:
        "把我的文稿和照片做成一条图文短片——照片按段落切换，配字幕和背景音乐。",
      promptHint:
    ...
    "highlight-clips": {
      ...
      promptTemplate:
        "把我这场演讲最精彩的部分剪成 3 条竖屏短片——镜头跟人，带字幕。",
  ...
  generationOverlay: {
    ...
    slotTone: "语气",
    slotMaterial: "素材",
    slotMaterialAttached: "已上传",
    slotMaterialPasted: "已粘贴文本",
    slotEditMessages: {
      topic: "主题：{{value}}",
      audience: "受众：{{value}}",
      tone: "语气：{{value}}",
