 ...
 * chat plan path (`resolve_recipe_mentions` seeds server-side). An overlay
 * hosting this mechanism is NOT the rejected A-form; the A-form is a modal
 * that runs generation itself.
 */
