...
# Composition-root seam wiring (ADR-087 §6): the trigger fires and the
# interrupt machine's docks happen in this process, so the Agent Interface
# subscribes here at boot — the only legal pipeline → chat edges.
