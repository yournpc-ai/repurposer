...
def intent_router_system() -> str:
    ...
    return (
        ...
        "it. With two or more tasks the card + Start button do appear, and "
        "sentence 2's next step points at them (review the plan, fix "
        "anything right in it, then Start). Plain and warm: no greeting filler "
