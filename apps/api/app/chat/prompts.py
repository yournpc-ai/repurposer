...
def intent_router_system() -> str:
    ...
    return (
        ...
        "book (a planned tool chain) is already on the table and the user's "
        ...
        "  'generate' has NO hard material requirement (2026-08-24 lift):\n"
        ...
        "    with no material, action='generate' is correct — never\n"
